...
return [
    ...
    'backup' => [
         ...
         */
        'password' => blank(env('BACKUP_ARCHIVE_PASSWORD')) ? null : env('BACKUP_ARCHIVE_PASSWORD'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => blank(env('MAIL_FROM_ADDRESS')) ? 'hello@example.com' : env('MAIL_FROM_ADDRESS'),
    ...
    'mail' => [
        'recipient' => env('BACKUP_RECIPIENT_EMAIL'),
    ],
