<div class="flex flex-col gap-7">
    ...
    <div class="flex flex-col gap-1 animate-auth-enter auth-stagger-1">
        <h1 class="text-2xl font-black tracking-tight text-stone-900">Set a new password</h1>
        <p class="text-sm text-stone-500">Choose a strong password for your account</p>
    </div>
    ...
    <form wire:submit="resetPassword" class="flex flex-col gap-5 animate-auth-enter auth-stagger-2">
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input
                ...
                autocomplete="email"
                readonly
                class="w-full px-3.5 py-2.5 rounded-xl border border-stone-200 bg-stone-50 text-stone-500 text-sm shadow-sm focus:outline-none cursor-default"
            />
            @error('email')
        ...
        <!-- New Password -->
        <div class="flex flex-col gap-1.5">
            <label for="password" class="text-sm font-semibold text-stone-700">New password</label>
        ...
        <!-- Confirm Password -->
        <div class="flex flex-col gap-1.5">
            <label for="password_confirmation" class="text-sm font-semibold text-stone-700">Confirm new password</label>
            <div x-data="{ show: false }" class="relative">
                <input
