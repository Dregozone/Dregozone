...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('title', 'Professional Developer')</title>
                    ...
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center">
                            <a href="{{ route('home') }}" class="text-2xl font-bold text-gray-900 dark:text-white">
                                <span class="text-blue-600 dark:text-blue-400">Anders</span>Learmonth
                            </a>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            Professional web developer specializing in Laravel, Livewire, and modern web technologies.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="{{ route('home') }}"
                                    class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Home</a>
                            </li>
                            <li><a href="{{ route('blog') }}"
                                    class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Blog</a>
                            </li>
                            <li><a href="{{ route('contact') }}"
                                    class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Contact</a>
                            </li>
                        </ul>
                    </div>
                    <div>
